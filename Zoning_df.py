...
the_geom = df['the_geom']
address = df['address']
allzoning1 = df['allzoning1']
allzoning2 = df['allzoning2']
assessland = df['assessland']
assesstot = df['assesstot']
bbl = df['bbl']
bldgarea = df['bldgarea']
bldgclass = df['bldgclass']
bldgdepth = df['bldgdepth']
bldgfront = df['bldgfront']
block = df['block']
borocode = df['borocode']
builtcode = df['builtcode']
builtfar = df['builtfar']
firecomp = df['firecomp']
histdist = df['histdist']
landmark = df['landmark']
lot = df['lot']
lotarea = df['lotarea']
lotdepth = df['lotdepth']
lotfront = df['lotfront']
lottype = df['lottype']
ltdheight = df['ltdheight']
numbldgs = df['numbldgs']
numfloors = df['numfloors']
overlay1 = df['overlay1']
overlay2 = df['overlay2']
ownername = df['ownername']
ownertype = df['ownertype']
resarea = df['resarea']
residfar = df['residfar']
retailarea = df['retailarea']
sanborn = df['sanborn']
spdist1 = df['spdist1']
spdist2 = df['spdist2']
unitsres = df['unitsres']
unitstotal = df['unitstotal']
xcoord = df['xcoord']
ycoord = df['ycoord']
yearbuilt = df['yearbuilt']
zonedist1 = df['zonedist1']
zonedist2 = df['zonedist2']
zonedist3 = df['zonedist3']
zonedist4 = df['zonedist4']
#####################################################
